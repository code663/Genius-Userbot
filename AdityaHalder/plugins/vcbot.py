...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://https://telegra.ph/file/b10a537123f2e32c4f559.jpg"
        ...
        try:
            ...
            title = "NaN"
            thumb_name = "https://telegra.ph/file/b10a537123f2e32c4f559.jpg"
            duration = "NaN"
            views = "NaN"
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await lel.edit("**💥 𝐏𝐀𝐖𝐀𝐍🤞𝐀𝐝𝐝𝐞𝐝 💿 𝐒𝐨𝐧𝐠❗️\n🔊 𝐀𝐭 💞 𝐏𝐨𝐬𝐢𝐭𝐢𝐨𝐧 » `{}` 🌷 ...**".format(position),
    )
    else:
        ...
        await lel.edit("**💥 𝐏𝐀𝐖𝐀𝐍🤞𝐌𝐮𝐬𝐢𝐜 🎸 𝐍𝐨𝐰 💞\n🔊 𝐏𝐥𝐚𝐲𝐢𝐧𝐠 😍 𝐎𝐏 🥀 ...**".format(),
        )
...
async def song(client, message):
    cap = "**🥀 𝐔𝐩𝐥𝐨𝐚𝐝𝐞𝐝 𝐁𝐲 ː [⛧‌ٖٖٖٖٖٖٜٖٖٖ𝐌ʀ𝆺꯭𝅥𓆩᪵🅿︎αωαη⍣⃟🔱⛧‌ٖٖٖٖٖٖٜٖٖٖ](https://t.me/PAWAN_IS_BACK)**"
